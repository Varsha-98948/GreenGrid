(function () {
	...
	function createFingerprint(platform, problemSlug, submissionId) {
	  if (submissionId) {
	    return `${platform}:${submissionId}`;
	  }
	  const timeWindow = Math.floor(Date.now() / 6e4);
	  return `${platform}:${problemSlug}:${timeWindow}`;
	}
	async function isAlreadyProcessed(fingerprint) {
	  try {
	    const result = await chrome.storage.local.get(STORAGE_KEY);
	    const entries = result[STORAGE_KEY] || [];
	    return entries.some(
	      (entry) => createFingerprint(entry.platform, entry.problemSlug, entry.submissionId) === fingerprint && Date.now() - entry.timestamp < TTL_MS
	    );
	  } catch (e) {
	...
	async function markAsProcessed(entry) {
	  try {
	    const result = await chrome.storage.local.get(STORAGE_KEY);
	...
	class LeetCodeAdapter {
	   ...
	   */
	  async checkForAcceptedSubmission(onAccepted) {
	   ...
	   */
	  isSubmissionResultContainer(el) {
	...
	const SavePrompt = ({ solution, onSave, onDismiss }) => {
	  ...
	  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.card, children: [
	    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.header, children: [
	      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.brandRow, children: [
	        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.brandLogo, children: "🌱" }),
	        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.brandTitle, children: "GreenGrid" })
	      ] }),
	    ...
	    state === "prompt" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.content, children: [
	      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.statusBadge, children: [
	        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.checkIcon, children: "✓" }),
	        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Solution Accepted" })
	      ] }),
	      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.problemInfo, children: [
	        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.problemTitle, children: solution.problemName }),
	        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.metaRow, children: [
	          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.langBadge, children: solution.language }),
	          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.platformBadge, children: solution.platform })
	        ] })
	      ] }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.questionText, children: "Save this solution to your GreenGrid portfolio?" }),
	      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.buttonGroup, children: [
	        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onDismiss, style: styles.secondaryBtn, children: "No, thanks" }),
	        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleConfirmSave, style: styles.primaryBtn, children: "Yes, Save" })
	      ] })
	    ] }),
	    state === "saving" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.content, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.loadingContainer, children: [
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.spinner }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.loadingText, children: "Saving to GreenGrid..." }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.loadingSubtext, children: "Committing and updating revision history" })
	    ] }) }),
	    state === "success" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.content, children: [
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.successIconContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.bigCheck, children: "✓" }) }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.successTitle, children: "Saved to GreenGrid!" }),
	      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.successDetails, children: [
	        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.problemTitle, children: result?.problemName || solution.problemName }),
	        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.metaRow, children: [
	          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.langBadge, children: solution.language }),
	          result?.isNewRevision ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: styles.revisionBadge, children: [
	            "Revision #",
	            result.revisionCount || 2
	          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.revisionBadge, children: "Revision #1" }),
	          result?.commitStatus && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.commitBadge, children: result.commitStatus === "COMMITTED" ? "GitHub: Committed" : result.commitStatus })
	        ] })
	      ] }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onDismiss, style: styles.doneBtn, children: "Done" })
	    ] }),
	    state === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.content, children: [
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.errorIconContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.errorMark, children: "!" }) }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.errorTitle, children: "Save Failed" }),
	      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.errorMessage, children: errorMessage }),
	      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.buttonGroup, children: [
	        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onDismiss, style: styles.secondaryBtn, children: "Dismiss" }),
	        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleConfirmSave, style: styles.primaryBtn, children: "Try Again" })
	      ] })
	    ] })
	  ] });
	};
	const styles = {
	  card: {
	    ...
	    boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.6), 0 10px 10px -5px rgba(0, 0, 0, 0.5), 0 0 15px rgba(16, 185, 129, 0.15)",
	    padding: "16px",
	...
	function showSavePrompt(solution) {
	  dismissPrompt();
